 ...
 **_NOTE:_** Recall that given a stochastic sequence of future discrete choices, the consumer problem is smooth and concave $\Rightarrow$ policy functions will have bounded MPCs: $\bar{L}<\infty$. 
