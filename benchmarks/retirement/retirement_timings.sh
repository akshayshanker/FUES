...
RANGES_DIR="benchmarks/retirement"      # @files resolved from REPO root (see cd below)
...
if [[ -n "${PBS_O_WORKDIR:-}" ]]; then
    # PBS job: user may submit from repo root OR from benchmarks/retirement/
...
# Resolve params file relative to benchmarks/retirement/
TIMINGS_SCRIPT_DIR="${REPO_ROOT}/benchmarks/retirement"
