...
from dcsmm.models.housing_renting.horses_common import piecewise_gradient, get_u_func

# Import GPU functions only if CUDA is available
if CUDA_AVAILABLE:
    from dcsmm.models.housing_renting.horses_common import bellman_obj_gpu, interp_gpu
